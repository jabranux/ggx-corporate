...
const specs: OrderSpec[] = [
  // ── QuadX Bridge canonical Claims sample data (12 transactions) ─────────
  // Tracking numbers match public.oms_mock_orders in the QuadX Bridge
  // (HeyQ) repo 1:1 — see scripts/supabase-seed-claims.mjs and
  // scripts/supabase-link-claims-ggx-corporate.mjs there, and
  // docs/migration/ggx-corporate-quadx-bridge-claims-integration.md here.
  // These are the transactions behind src/app/data/claims.ts's CLM-1009..
  // CLM-1020 — the SAME reference GGX Corporate and Bridge both use, not
  // two independently-invented mocks.
  { tracking: 'GGX-2026-CLM-0001', consignor: 'acme-corp', recipient: 'Liza Fernandez', contactNumber: '+639171234601', recipientLine1: 'Visayas Ave, Bagong Pag-asa', recipientDistrict: 'Bagong Pag-asa', city: 'Quezon City', scenario: 'in_transit_forwarded', bookingDate: '2026-05-31', service: 'next_day', shipment: 'small-box', product: PRODUCTS[6], codBaseline: 2450, insured: true, paymentMethod: 'cod', serviceFeesPayor: 'buyer', transactionScenario: 'PUD', riderIndex: 0 },
  { tracking: 'GGX-2026-CLM-0002', consignor: 'acme-luzon', recipient: 'Noel Castillo', contactNumber: '+639171234602', recipientLine1: 'Ortigas Ave Ext, Oranbo', recipientDistrict: 'Oranbo', city: 'Pasig City', scenario: 'delivered_first_attempt', bookingDate: '2026-05-30', service: 'same_day', shipment: 'medium-box', product: PRODUCTS[11], codBaseline: 5120, insured: true, paymentMethod: 'prepaid', serviceFeesPayor: 'buyer', transactionScenario: 'PUD', riderIndex: 1 },
  { tracking: 'GGX-2026-CLM-0003', consignor: 'acme-corp', recipient: 'Grace Villaruel', contactNumber: '+639171234603', recipientLine1: 'Shaw Boulevard, Wack-Wack', recipientDistrict: 'Wack-Wack', city: 'Mandaluyong City', scenario: 'returned_terminal', bookingDate: '2026-05-28', service: 'next_day', shipment: 'medium-box', product: PRODUCTS[5], codBaseline: 3300, insured: true, paymentMethod: 'cod', serviceFeesPayor: 'seller', transactionScenario: 'PUD', riderIndex: 2, failureReason: 'address_not_found' },
  { tracking: 'GGX-2026-CLM-0004', consignor: 'acme-luzon', recipient: 'Arnel Sison', contactNumber: '+639171234604', recipientLine1: 'Fort Bonifacio, BGC', recipientDistrict: 'Fort Bonifacio', city: 'Taguig City', scenario: 'failed_for_return', bookingDate: '2026-05-27', service: 'same_day', shipment: 'small-box', product: PRODUCTS[6], codBaseline: 1875, insured: false, paymentMethod: 'cod', serviceFeesPayor: 'buyer', transactionScenario: 'PUD', riderIndex: 0, failureReason: 'recipient_unavailable' },
  { tracking: 'GGX-2026-CLM-0005', consignor: 'acme-corp', recipient: 'Ivy Marasigan', contactNumber: '+639171234605', recipientLine1: 'Salcedo Village, Bel-Air', recipientDistrict: 'Bel-Air', city: 'Makati City', scenario: 'in_transit_exchange', bookingDate: '2026-05-24', service: 'next_day', shipment: 'medium-box', product: PRODUCTS[10], codBaseline: 4200, insured: true, paymentMethod: 'cod', serviceFeesPayor: 'seller', transactionScenario: 'PUD', riderIndex: 1 },
  { tracking: 'GGX-2026-CLM-0006', consignor: 'acme-luzon', recipient: 'Bea Ramos', contactNumber: '+639171234606', recipientLine1: 'Sto. Nino St, Concepcion Uno', recipientDistrict: 'Concepcion Uno', city: 'Marikina City', scenario: 'picked_up_shallow', bookingDate: '2026-05-23', service: 'next_day', shipment: 'small-pouch', product: PRODUCTS[13], codBaseline: 980, insured: false, paymentMethod: 'cod', serviceFeesPayor: 'buyer', transactionScenario: 'PUD', riderIndex: 2 },
  { tracking: 'GGX-2026-CLM-0007', consignor: 'acme-corp', recipient: 'Carlo Dizon', contactNumber: '+639171234607', recipientLine1: 'Roxas Blvd, Malibay', recipientDistrict: 'Malibay', city: 'Pasay City', scenario: 'failed_out_for_return', bookingDate: '2026-05-22', service: 'next_day', shipment: 'medium-box', product: PRODUCTS[9], codBaseline: 2750, insured: true, paymentMethod: 'cod', serviceFeesPayor: 'seller', transactionScenario: 'PUD', riderIndex: 0, failureReason: 'address_not_found' },
  { tracking: 'GGX-2026-CLM-0008', consignor: 'acme-luzon', recipient: 'Ella Ponce', contactNumber: '+639171234608', recipientLine1: 'N. Domingo St, Valencia', recipientDistrict: 'Valencia', city: 'San Juan City', scenario: 'in_transit_forwarded', bookingDate: '2026-05-21', service: 'instant', shipment: 'large-box', product: PRODUCTS[10], codBaseline: 6100, insured: true, paymentMethod: 'cod', serviceFeesPayor: 'seller', transactionScenario: 'PUD', riderIndex: 1 },
  { tracking: 'GGX-2026-CLM-0009', consignor: 'acme-corp', recipient: 'Miguel Torres', contactNumber: '+639171234609', recipientLine1: 'Grace Park, 10th Ave', recipientDistrict: 'Grace Park', city: 'Caloocan City', scenario: 'picked_up_for_transfer', bookingDate: '2026-05-18', service: 'next_day', shipment: 'small-pouch', product: PRODUCTS[14], codBaseline: 1500, insured: false, paymentMethod: 'wallet', serviceFeesPayor: 'buyer', transactionScenario: 'PUD', riderIndex: 2 },
  { tracking: 'GGX-2026-CLM-0010', consignor: 'acme-luzon', recipient: 'Divina Reyes', contactNumber: '+639171234610', recipientLine1: 'SM Sucat, Sucat', recipientDistrict: 'Sucat', city: 'Paranaque City', scenario: 'delivered_after_retry', bookingDate: '2026-05-17', service: 'same_day', shipment: 'medium-box', product: PRODUCTS[5], codBaseline: 3400, insured: true, paymentMethod: 'cod', serviceFeesPayor: 'buyer', transactionScenario: 'PUD', riderIndex: 0, failureReason: 'recipient_unavailable' },
  { tracking: 'GGX-2026-CLM-0011', consignor: 'acme-corp', recipient: 'Patricia Nolasco', contactNumber: '+639171234611', recipientLine1: 'Filinvest City, Alabang', recipientDistrict: 'Alabang', city: 'Muntinlupa City', scenario: 'returned_terminal', bookingDate: '2026-05-14', service: 'next_day', shipment: 'small-box', product: PRODUCTS[8], codBaseline: 2999, insured: true, paymentMethod: 'cod', serviceFeesPayor: 'buyer', transactionScenario: 'PUD', riderIndex: 1, failureReason: 'refused_by_recipient' },
  { tracking: 'GGX-2026-CLM-0012', consignor: 'acme-luzon', recipient: 'Ronaldo Aquino', contactNumber: '+639171234612', recipientLine1: 'BF Homes, Talon', recipientDistrict: 'Talon', city: 'Las Pinas City', scenario: 'failed_return_in_transit', bookingDate: '2026-05-12', service: 'next_day', shipment: 'small-pouch', product: PRODUCTS[6], codBaseline: 1120, insured: false, paymentMethod: 'cod', serviceFeesPayor: 'seller', transactionScenario: 'PUD', riderIndex: 2, failureReason: 'address_not_found' },
